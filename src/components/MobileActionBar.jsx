...
import { CartIcon, PhoneIcon, WhatsAppIcon } from './Icons'
...
export default function MobileActionBar() {
  ...
  return (
    <aside
      ...
      className="fixed bottom-0 left-0 right-0 z-40 border-t border-stone-200 bg-white px-3 py-3 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] md:hidden dark:bg-stone-900 dark:border-stone-800"
    >
      <div className="mx-auto flex max-w-md items-center justify-between gap-2.5">
        ...
        <a
          ...
          onClick={handleCall}
          className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-stone-200 bg-stone-50 py-3 text-sm font-bold text-stone-800 transition active:scale-95 hover:bg-stone-100"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#25D366] py-3 text-sm font-bold text-white shadow-xs transition active:scale-95 hover:bg-[#1fb855]"
        >
